...
StimulusCodes = {'Stimulus','S','C', 'S 10', 'S 20'};   %Stimulus presentations have this evt.type code
...
FullFileConversion = 0;      %Convert full file (1) or not (0)
...
HRchannelnames = {'HR','pulse','PPU', '12'};                   %Name of SCR channel in brainamp file (add any option)
Respchannelnames = {'Resp','Respiration','Breath','RESP', '13'};               %Name of SCR channel in brainamp file (add any option)
