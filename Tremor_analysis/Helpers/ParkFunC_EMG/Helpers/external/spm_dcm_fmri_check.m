...
'variance explained %0.0f%%', D(1));
str = {

'responses and predictions',str};
if
...
spm_plot_ci(qE(i),qC(i,i)), hold

on
str = sprintf(

'largest connection strength %0.2f', D(2));
str = {

'intrinsic and extrinsic connections',str};
if
...
'posterior correlations','FontSize',16)
str = sprintf(

'estimable parameters %0.0f', D(3));
str = {

'posterior correlations',str};
if
